...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    void shouldDoNotCrossSubTasks() {
        ...
        assertEquals(epic.getStartTime(), subTask.getStartTime(), "Время Epic будет равно SubTask " +
                "из-за пересечения");
        ...
        assertEquals(epic.getEndTime(), subTask1.getEndTime(), "Время окончания Epic будет равно" +
                "концу самой поздней SubTask");
        assertEquals(epic.getStatus(), subTask1.getStatus(), "Если у SubTask изменился статус, " +
        ...
        assertEquals(epic.getStartTime(), subTask.getStartTime(), "Время начала Epic будет равно началу" +
                "самой ранней SubTask");
        assertEquals(epic.getEndTime(), subTask.getEndTime(), "Время окончания Epic будет равно " +
                "SubTask у которой статус не DONE");
